# -----------------------------------------------------------------------------
# ECS Cluster, Task Definitions, Fargate Service, IAM, Auto-Scaling
# -----------------------------------------------------------------------------
...
# Task Execution Role (Allows ECS agent to pull ECR images, write CloudWatch logs, and fetch Secrets Manager secrets)
...
# Policy allowing execution role to read database secrets from AWS Secrets Manager
...
# Task Role (Allows application running inside container to call AWS APIs if needed)
...
# Auto-Scaling: Target Tracking for CPU (Target 70% utilization)
...
# Auto-Scaling: Target Tracking for Memory (Target 80% utilization)
